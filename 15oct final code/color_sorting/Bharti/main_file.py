    ...
    while(1):
        ...
        while start[0] == 1 and end == 0:
            ...
            if end == 0:
                ...
                upper_white = np.array([179,205,255])
                ...
                for white_c in white_contours:
                    ...
                    if white_area>50000:          ## Setting the threshold for base area                      
                        ...
                        # lower = {'yellow': (0,36,161), 'green': (50,38,0),'red':(0,142,158)}
                        # upper = {'yellow':  (179,255,255), 'green': (100,147,170),'red':(9,255,221)}
                        # colors = {'yellow': (0, 255, 217), 'green': (0, 255,0),'red':(0,0,255)}
                        lower = {'yellow': (19,165,0),'red':(0,255,255)}
                        upper = {'yellow':  (38,255,255),'red':(0,255,132)}
                        colors = {'yellow': (0, 255, 217),'red':(9,255,255)}
                ...
                dcxx=int(y*(-0.6408)+755.85)
                dcyy=int(x*(-0.6855)+221.35)
                print(dcxx,dcyy)
