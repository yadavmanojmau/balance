...
void loop() 
{
  ...
  if(bin==8)
  {
      ...
      
    {
      if(task ==55)
     {
        Serial.println("yadav");
        DobotHome();
        moveDobot(222,6,-31,1);
        delay(3000);
        moveDobot(265,-65,-65,1);
        delay(3000);
        moveDobot(-181,-184,-65,1);
        delay(3000);
        moveDobot(265,-65,-65,1);
        delay(3000);
