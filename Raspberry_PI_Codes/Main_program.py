...
if task_input == 1:    
    while(cap.isOpened()):
        ...
        if flag % 5 == 0:
            ...
            box_lower_blue = np.array([0,0,87])
            box_upper_blue = np.array([179,52,255])
            '''
            ...
            for box_c in box_contours:
                box_area = cv2.contourArea(box_c)  ### Get area of the contour detected111
                if box_area>50000:          ## Setting the threshold for blue area
                    ...
                    lower = {'yellow': (13,79,0), 'green': (0, 8, 0)}
                    upper = {'yellow':  (52,255,255), 'green': (179, 154, 74)}
                        ...
                        if(len(com_X)>=1):
                            with SMBus(1) as bus:
                               ...
                               -0.7429)+200.26
                                ...
                                ''' 
                                dcyy=int(com_Y[0]*(-0.4903)+174.29)      
                                dcxx=int(com_X[0]*(-0.4916)+326.13)  


                                
                                # dcxx=int(com_X[0]*(-0.41999)+342.64)      
                                # dcyy=int(com_Y[0]*(-0.5785)+195.11)
                                ...
                                # if dcyy >300 or dcyy<-280:
                                #  print(dcxx)
                                #  print("max value of y")
                                #  break
                                ...
                                2. dcxx - X coordinates of th object detected 
                                ...
                                '''
                                data = [0,170,0,127,0,7,0,1,detected_color]       
                                bus.write_i2c_block_data(20,0,data)
                                time.sleep(3)
                                ...
                                time.sleep(3)
                                ''' 
                                data = [0,120,0,181,1,27,1,5,detected_color]    
                                bus.write_i2c_block_data(20,0,data)
                                time.sleep(2)

                                data = [dcx,dcxx,dcy,dcyy,1,25,1,5,detected_color]
                                bus.write_i2c_block_data(20,0,data)
                                time.sleep(5)
                               
                                
                                # data = [0,120,0,181,0,27,1,1,detected_color]    
                                # bus.write_i2c_block_data(20,0,data)
                                # time.sleep(3)
...
'''
    ...
    with SMBus(1) as bus: 
                data = [0,169,1,160,0,78,0,1,1,55]         
                bus.write_i2c_block_data(20,0,data)
                time.sleep(10)
                data = [0,169,1,160,0,78,0,1,1,100]         
                bus.write_i2c_block_data(20,0,data)
                time.sleep(5)
    print("Values sent")
