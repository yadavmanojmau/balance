        ...
        if flag % 5 == 0:
            ...
            for box_c in box_contours:
                ...
                if box_area>50000:          ## Setting the threshold for blue area
                    ...
                    lower = {'yellow': (20,130,0), 'green': (90, 120, 30)}
                    upper = {'yellow':  (31,255,255), 'green': (109, 245, 255)}
                    ...
                    for key, value in upper.items():
                        ...
                        if(len(com_X)>=1):
                            with SMBus(1) as bus:   
                                dcxx=int(com_X[0]*(-0.39)+96.01)
                                dcyy=int(com_Y[0]*(-0.58)-41.818)
                                command = 1
                                '''
...
'''    
    ...
    with SMBus(1) as bus: 
                data = [0,169,1,160,0,78,0,66,55,55]         
                bus.write_i2c_block_data(20,0,data)
                time.sleep(5)
    print("Values sent")