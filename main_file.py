...
# c.host(SERVER_HOST)             
# c.port(SERVER_PORT)       
c1 = ModbusClient(host="192.168.0.10",port=502,unit_id=1, auto_open=True)  # Create an instance of the Modbus Client and this will be used further
               ...
               ## white_frame = frame[20:330, 255:550]  
                ...
                for white_c in white_contours:
                    ...
                    if white_area>50000:          ## Setting the threshold for base area                      
                        ...
                        colors = {'yellow': (0, 255, 217), 'red': (0, 0, 255), 'green': (0, 255, 0)}  # hsv value of red yellow
                ...
                # dcxx=int(y*(-0.6074)+753.68)
                # dcyy=int(x*(-0.608)+299.37)
                # print(dcxx,dcyy)
                ...
                # P_CY = c1.write_single_register(CX_addr, int(dcxx))
                # P_CX = c1.write_single_register(CY_addr, int(dcyy))
